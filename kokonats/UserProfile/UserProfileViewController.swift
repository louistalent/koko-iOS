...
class UserProfileViewController: UIViewController {
    ...
    private func configureLayout() {
        ...
        logoutBgView.activeConstraints(directions: [.top(.top, 35), .trailing(.trailing, -24)])
        ...
        iconView.activeConstraints(to: containerView, directions: [.top(.top, 80), .centerX])
        ...
        settingButton.activeConstraints(to: iconView, directions: [.leading(.leading, 100), .centerY])
        ...
        historyTableView.activeSelfConstrains([.height(420)])
    ...
    @objc func logoutAction() {
        let alert = UIAlertController(title: "user_logout_message_title".localized, message: "", preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "user_logout_cancel".localized, style: .cancel, handler: { _ in
        }))
        alert.addAction(UIAlertAction(title: "user_logout_ok".localized, style: .default, handler: { [weak self]_ in
...
extension UserProfileViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section + 1 == tableViewCellCount, shouldShowMorebutton {
